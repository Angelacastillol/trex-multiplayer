...
3 //tareas: carga imagenes de obstaculos y de nubes.
...
function setup() {
  ...
  ground=createSprite(300,190,windowHeight,10);
  ground.addImage("ground",groundImage);
  ground.x = ground.width /2;
  invisibleGround = createSprite(300,190,windowHeight,10);
  invisibleGround.visible=false;

  ground2=createSprite(300,400,windowWidth,10);
...
function draw() {
  ...
  if (keyDown("space") && trex1.y>=128) {
  trex1.velocityY = -10;
  }else if(keyDown("UP_ARROW") && trex2.y>=346) {
    trex2.velocityY = -10;
  }
